...
export default function BusinessBanner1({ data = {}, blocks }: SectionProps) {
  ...
  const bannerBackground =
    backgroundMode === "gradient"
      ? `linear-gradient(90deg, ${data.bannerBackgroundColor ?? "#0f172a"}, ${data.bannerGradientColor ?? "#0ea5e9"
      })`
