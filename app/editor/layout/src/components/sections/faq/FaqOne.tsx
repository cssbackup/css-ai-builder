...
const fallbackItems = [
  { question: "Is there a free trial available?", answer: "Yes, you can try us for free and upgrade when ready." },
  { question: "Can I change my plan later?", answer: "Of course. You can adjust your plan as your needs change." },
  ...
  { question: "How do I change my account email?", answer: "You can update account details from settings." },
    ...
    <section className="bg-white bg-[linear-gradient(#f1f5f9_1px,transparent_1px),linear-gradient(90deg,#f1f5f9_1px,transparent_1px)] bg-[size:42px_42px] px-5 py-12 sm:py-16">
      <div className="mx-auto max-w-7xl">
        <span className="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-3 py-1 text-xs font-semibold">
          <BadgeHelp size={14} /> FAQs
        </span>
        <h2 className="mt-7 text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl md:text-5xl">
          {data.title ?? "Frequently asked questions"}
        </h2>
        <p className="mt-4 text-base text-slate-600">
          {data.desc ?? "Stuck on something? We're here to help with all your questions and answers in one place."}
        </p>
